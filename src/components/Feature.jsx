...
const Feature = () => {
    return (
        <>
            <div className="featureContainer" style={{margin: "100px 50px 100px 60px"}}>
                <h1 className="featureContainerHeader" style={{color: "#384a62", fontFamily: "Times new roman, sans-serif", margin: "0px 0px 20px"}}>You can count on us for:</h1>
                <div className="featureChildContainer" style={{display: "flex"}}>
                    <div className="featureWrapper" style={{display: "flex"}}>
